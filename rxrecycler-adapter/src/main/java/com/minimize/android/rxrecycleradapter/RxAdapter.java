...
public class RxAdapter<DataType, LayoutBinding extends ViewDataBinding>
    ...
    @Override
    public void onBindViewHolder(final SimpleViewHolder<DataType, LayoutBinding> holder,
                                 final int position) {
    ...
    public void updateInsertedDataSet(List<DataType> dataSet, int startPosition, int count) {
        mDataSet = dataSet;
        notifyItemRangeInserted(startPosition, count);
    }

    public void updateRemovedDataSet(List<DataType> dataSet, int startPosition, int count) {
        mDataSet = dataSet;
